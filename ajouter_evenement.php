...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO evenements (titre, description, date_event, lieu, utilisateur_id) VALUES (?, ?, ?, ?, ?)");
    $stmt->execute([$titre, $desc, $date, $lieu, $uid]);
    $valide = "Événement ajouté ! <a href='dashboard_user.php'>Retour</a>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    Date: <input type="date" name="date_event" required><br>
